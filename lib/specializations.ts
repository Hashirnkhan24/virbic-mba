...
export const mbaSpecializations: Specialization[] = [
  {
    ...
    shortName: "Finance",
    overview: {
      description: "MBA in Finance focuses on financial management, investment analysis, corporate finance, and financial planning. Professionals in this field work on understanding, managing, and improving an organization's financial health and investment decisions.",
      focusStatement: "The finance specialization remains one of the most sought-after and highest-paying MBA tracks in India, attracting candidates with strong analytical abilities and interest in capital markets.",
      keyPoints: [
    ...
    salary: {
      entryLevel: {
        ...
        topCampuses: "Rs. 25,00,000 - Rs. 40,00,000 per annum (up to Rs. 1 crore for international roles)"
      },
      midLevel: "Rs. 12,00,000 - Rs. 25,00,000 per annum (3-5 years experience)",
    ...
    marketOutlook: {
      futureRelevance: "HIGH - Finance remains a core business function with increasing complexity",
      automationRisk: "MEDIUM - Strategic decisions and complex problem-solving require human expertise",
      demandTrend: "GROWING - India's growing economy and expanding capital markets drive continuous demand"
    },
    workNature: {
      creativity: "Medium - requiring innovative solutions to complex financial challenges",
      analyticalThinking: "HIGH - heavy emphasis on quantitative analysis and financial modeling",
      peopleInteraction: "Medium - regular interaction with stakeholders and internal teams",
      stressLevel: "HIGH - especially in investment banking and trading roles",
      travelFrequency: "Low to Medium - depending on role and client requirements",
      workHours: "50-70 hours/week in investment banking; 45-55 hours/week in corporate finance"
    },
    typicalWorkStyle: "Analyzing financial statements, building financial models, conducting valuation exercises, and preparing investment recommendations. Work is project-based with quarterly and annual reporting cycles.",
  ...
  },
  {
    ...
    shortName: "Marketing",
    overview: {
      description: "MBA in Marketing focuses on brand management, consumer behavior, digital marketing, and market strategy. Professionals in this field work on understanding, managing, and improving customer acquisition, retention, and brand positioning.",
      focusStatement: "Marketing is often called the heart of business as it directly connects organizations with their customers.",
      keyPoints: [
    ...
    salary: {
      ...
      midLevel: "Rs. 12,00,000 - Rs. 20,00,000 per annum (3-5 years experience)",
      seniorLevel: "Rs. 35,00,000+ per annum for senior brand managers and marketing heads",
    ...
    marketOutlook: {
      futureRelevance: "HIGH - Marketing evolves with technology but remains essential for business growth",
      automationRisk: "LOW - Strategy and creativity require human expertise",
      demandTrend: "GROWING - Digital transformation and e-commerce expansion drive continuous demand"
    },
    workNature: {
      creativity: "HIGH - requiring constant innovation in messaging, campaigns, and strategies",
      analyticalThinking: "HIGH - data analytics and consumer insights are critical",
      peopleInteraction: "HIGH - extensive collaboration with agencies, teams, and stakeholders",
      stressLevel: "Medium to HIGH - campaign deadlines and performance pressure",
    ...
    typicalWorkStyle: "Developing brand strategies, planning campaigns across multiple channels, analyzing consumer insights, and managing agency relationships. Work is project-based with quarterly planning cycles.",
    typicalResponsibilities: [
  ...
  },
  {
    ...
    overview: {
      description: "MBA in Human Resources focuses on talent management, organizational behavior, employee relations, and strategic workforce planning. Professionals in this field work on understanding, managing, and improving the human capital of organizations.",
      focusStatement: "HR has evolved from an administrative function to a strategic partner in business success.",
      keyPoints: [
    ...
    salary: {
      entryLevel: {
        ...
        topCampuses: "Rs. 17,00,000 - Rs. 30,00,000 per annum (XLRI particularly renowned)"
      },
      midLevel: "Rs. 10,00,000 - Rs. 18,00,000 per annum (3-5 years experience)",
      seniorLevel: "Rs. 30,00,000+ per annum for senior HR managers and directors",
      executiveLevel: "CHRO positions at large organizations earn significantly more"
    },
    industries: [
    ...
    marketOutlook: {
      futureRelevance: "HIGH - People management remains critical despite automation",
      automationRisk: "LOW - HR requires human judgment, empathy, and relationship building",
      demandTrend: "GROWING - Focus on employee experience and talent retention drives demand"
    },
    workNature: {
      creativity: "Medium - requiring innovative approaches to engagement and culture building",
      analyticalThinking: "Medium - HR analytics and data-driven decision making are growing",
      peopleInteraction: "HIGH - constant engagement with employees at all levels",
      stressLevel: "Medium - handling conflicts and sensitive situations can be challenging",
    ...
    typicalWorkStyle: "Talent acquisition, employee engagement initiatives, performance management, and policy development. Work combines operational tasks with strategic projects.",
    typicalResponsibilities: [
  ...
  },
  {
    ...
    overview: {
      description: "MBA in Operations focuses on supply chain management, process optimization, logistics, and operational excellence. Professionals in this field work on understanding, managing, and improving the systems and processes that deliver products and services to customers.",
      focusStatement: "Operations is the engine that powers business execution.",
      keyPoints: [
    ...
    salary: {
      entryLevel: {
        ...
        topCampuses: "Rs. 20,00,000 - Rs. 35,00,000 per annum (IIM Mumbai particularly renowned)"
      },
      midLevel: "Rs. 12,00,000 - Rs. 22,00,000 per annum (3-5 years experience)",
      seniorLevel: "Rs. 35,00,000+ per annum for senior operations managers and supply chain directors",
      executiveLevel: "COO positions at large organizations earn significantly more"
    },
    industries: [
    ...
    marketOutlook: {
      futureRelevance: "HIGH - Operations efficiency is critical for competitive advantage",
      automationRisk: "MEDIUM - Technology augments but doesn't replace operations expertise",
      demandTrend: "GROWING - E-commerce boom and supply chain complexity drive demand"
    },
    workNature: {
      creativity: "Medium - requiring innovative solutions to process challenges",
      analyticalThinking: "HIGH - heavy emphasis on data analysis and optimization",
      peopleInteraction: "Medium - coordination with multiple internal and external stakeholders",
      stressLevel: "Medium to HIGH - meeting delivery deadlines and managing disruptions",
      travelFrequency: "Medium - site visits, supplier meetings, and logistics coordination",
      workHours: "50-60 hours/week depending on industry and role"
    },
    typicalWorkStyle: "Process mapping, supply chain optimization, inventory management, and quality assurance. Daily work involves collaboration with procurement, manufacturing, and logistics teams. Work is operational with continuous improvement cycles.",
    typicalResponsibilities: [
  ...
  },
  {
    ...
    overview: {
      description: "MBA in Information Systems focuses on technology management, digital transformation, business analytics, and IT strategy. Professionals in this field work on understanding, managing, and improving the technology infrastructure and digital capabilities of organizations.",
      focusStatement: "In today's digital economy, technology leadership is business leadership.",
      keyPoints: [
    ...
    salary: {
      entryLevel: {
        ...
        topCampuses: "Rs. 20,00,000 - Rs. 35,00,000 per annum (product management and data science roles higher)"
      },
      midLevel: "Rs. 15,00,000 - Rs. 28,00,000 per annum (3-5 years experience)",
      seniorLevel: "Rs. 40,00,000+ per annum for senior IT managers and analytics leaders",
    ...
    marketOutlook: {
      futureRelevance: "HIGH - Digital transformation is a top priority for all organizations",
      automationRisk: "LOW - Technology professionals drive automation, not replaced by it",
      demandTrend: "GROWING - AI, cloud, and data analytics drive exponential demand"
    },
    workNature: {
      creativity: "Medium - requiring innovative approaches to technology solutions",
      analyticalThinking: "HIGH - heavy emphasis on data analysis and system design",
      peopleInteraction: "Medium - collaboration with technical and business teams",
      stressLevel: "Medium to HIGH - project deadlines and system criticality create pressure",
      travelFrequency: "Low to Medium - depending on client and project requirements",
      workHours: "45-60 hours/week with flexibility in many tech organizations"
    },
    typicalWorkStyle: "IT project management, business analysis, data analytics, and technology strategy development. Daily work involves collaboration with development teams, business stakeholders, and vendors. Work is project-based with agile methodologies.",
    typicalResponsibilities: [
    ...
    careerProgression: {
      ...
      executive: "Chief Information Officer (CIO) or Chief Technology Officer (CTO)"
    },
    topInstitutes: [
      "IIM Bangalore",
      "IIM Calcutta",
  ...
  },
  {
    ...
    shortName: "Sales",
    overview: {
      description: "MBA in Sales focuses on business development, sales strategy, relationship management, and revenue generation. Professionals in this field work on understanding, managing, and improving the sales performance and customer acquisition efforts of organizations.",
      focusStatement: "Sales is the lifeblood of business, directly driving revenue and growth.",
      keyPoints: [
    ...
    salary: {
      entryLevel: {
        ...
        topCampuses: "Rs. 15,00,000 - Rs. 28,00,000 per annum (high performers can exceed significantly)"
      },
      midLevel: "Rs. 12,00,000 - Rs. 25,00,000 per annum (3-5 years experience)",
      seniorLevel: "Rs. 40,00,000+ per annum for senior sales managers and directors",
      executiveLevel: "Significant variable components can substantially increase total compensation"
    },
    industries: [
      "FMCG and Consumer Goods",
      "Banking and Financial Services",
    ...
    marketOutlook: {
      ...
      automationRisk: "LOW - While tools assist, relationships and closing require humans",
      demandTrend: "GROWING - Economic expansion and new market creation drive demand"
    },
    workNature: {
      creativity: "Medium - requiring innovative approaches to customer engagement",
      analyticalThinking: "Medium - data-driven sales planning and forecasting are important",
      peopleInteraction: "HIGH - constant engagement with customers and stakeholders",
      stressLevel: "HIGH - revenue targets and performance pressure create stress",
      travelFrequency: "HIGH - client meetings, market visits, and territory coverage",
      workHours: "50-70 hours/week with irregular schedules"
    },
    typicalWorkStyle: "Prospecting, client meetings, proposal development, and deal closure. Daily work involves collaboration with marketing, product teams, and operations. Work is target-driven with monthly and quarterly cycles.",
    typicalResponsibilities: [
...
export const getSpecializationByName = (name: string): Specialization | undefined => {
...
export const getSalaryRangeBySpecialization = (id: string, level: 'entry' | 'mid' | 'senior' | 'executive' = 'entry') => {
  const spec = getSpecializationById(id);
  if (!spec) return null;
